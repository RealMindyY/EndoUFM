...
class MonodepthOptions:
    def __init__(self):
        ...
        self.parser.add_argument("--data_path",
                                 ...
                                 default="/hdd2/yxn/endovis_data/") 
        self.parser.add_argument("--log_dir",
                                 type=str,
                                 help="log directory",
                                 default="/hdd2/yxn/code/my_sfm2/results") 
        ...
        self.parser.add_argument("--lora_type",
                                 ...
                                 choices=["lora", "dvlora", "none","rvlora"],
                                 default="rvlora") #修改
        ...
        #SAM options
     #    self.parser.add_argument("--model_type", type=str, default="vit_b", help="sam model_type")
     #    self.parser.add_argument("--sam_checkpoint", type=str, default="/hdd/2/lbj/my_sfm2/SAM_Med2D/pretrain/sam-med2d_b.pth", help="sam checkpoint")
     #    self.parser.add_argument("--image_size", type=int, default=256, help="image_size")
     #    self.parser.add_argument("--encoder_adapter", type=bool, default=True, help="use adapter")
        ...
        self.parser.add_argument("--models_to_load",
                                 ...
                                 type=str,
                                 help="models to load",
                                 default=["adjust_net", "decompose", "decompose_encoder", "depth_model", "pose", "pose_encoder"]) # "decompose_decoder", 
        ...
        self.parser.add_argument("--model_type",
                                 type=str,
                                 help="endoufm or endodac or depthanything or afsfm",
                                 default="endoufm",
                                 choices=["endoufm", "afsfm", "depthanything"])
        ...
        self.parser.add_argument("--eval_split",
                                 type=str,
                                 default="endovis",
                                 choices=["endovis","SERV-CT","hamlyn", "endonerf"],
