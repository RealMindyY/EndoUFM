...
class DPTHead(nn.Module):
    ...
    def forward(self, out_features, patch_h, patch_w):
        ...
        outputs = {}
        l = self.conv_depth_4(path_4)
        outputs[("disp", 3)] = self.sigmoid(l)
        ...
        if lora_type != "none":
            for t_layer_i, blk in enumerate(encoder.blocks):
                ...
                if lora_type == "dvlora":
                    ...
                    # blk.attn.qkv = RVLinear(qkv_in_features, qkv_out_features, r=self.r, lora_alpha=self.r,random1=random_2_1,random2=random_2_2)
